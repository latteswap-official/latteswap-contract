...
import { masterBaristaV1E2ETestFixture } from "../helpers/fixtures/MasterBaristaV1";

chai.use(solidity);
const { expect } = chai;

describe("MasterBaristaV1 e2e", () => {
  ...
  beforeEach(async () => {
    ...
    } = await waffle.loadFixture(masterBaristaV1E2ETestFixture));
