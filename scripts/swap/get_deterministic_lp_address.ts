...
async function main() {
  ...
  const tokens =
    PAIR_ADDRESS.TOKEN0.toLowerCase() < PAIR_ADDRESS.TOKEN1.toLowerCase()
      ? [PAIR_ADDRESS.TOKEN0, PAIR_ADDRESS.TOKEN1]
      : [PAIR_ADDRESS.TOKEN1, PAIR_ADDRESS.TOKEN0]; // does safety checks
  ...
  console.log(
    `>> ✅ Done generated lp address of pair ${PAIR_ADDRESS.TOKEN0} - ${PAIR_ADDRESS.TOKEN1} is: ${lpAddress}`
  );
}
