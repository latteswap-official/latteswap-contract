...
async function main() {
  ...
  */
  ...
  for (let STAKING_POOL of STAKING_POOLS) {
    ...
    console.log(`>> Execute Master Transaction to setStakeTokenCallerAllowancePool ${STAKING_POOL.STAKING_TOKEN_ADDRESS}`);
    estimatedGas = await masterBarista.estimateGas.setStakeTokenCallerAllowancePool(STAKING_POOL.STAKING_TOKEN_ADDRESS, true)
    ...
    console.log(`>> Execute Master Transaction to addStakeTokenCallerContract of ${STAKING_POOL.STAKING_TOKEN_ADDRESS} having this caller ${config.Booster}`);
    estimatedGas = await masterBarista.estimateGas.addStakeTokenCallerContract(STAKING_POOL.STAKING_TOKEN_ADDRESS, config.Booster)
